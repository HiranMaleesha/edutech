...
export default function Home() {
      ...
      <div className="pt-16">
              ...
              <div className="space-y-8">
                <div>
                  <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 font-poppins leading-tight">
                    ...
                    <span className="text-[#004C3F]"> Ofqual-Regulated</span> Qualifications!
                  </h1>
                </div>

                <p className="text-lg text-gray-600 max-w-lg">
                  Join 100,000+ learners and earn accredited diplomas trusted by top employers like Deloitte and NHS. Study online, at your pace.
                </p>
                ...
                <div className="flex flex-wrap gap-3">
                  {['Business & Management', 'Health & Social Care', 'Information Technology', 'Teaching & Education', 'Accounting & Finance'].map((category) => (
                    <span
                      key={category}
        ...
        <section className="bg-[#004C3F] py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-8 items-center">
              {['Deloitte', 'NHS', 'Octopus', 'TalkTalk', 'Virgin Media'].map((company) => (
                <div key={company} className="text-white text-lg font-semibold opacity-80">
                  {company}
                </div>
              ))}
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold font-poppins">
                Explore <span className="text-[#004C3F]">Popular</span> Career Paths
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {coursesLoading ? (
                ...
                dynamicCourses.map((course, index) => {
                  ...
                  const modules = Math.max(3, Math.floor(course.duration / 10) + 2);
                  const weeks = Math.max(6, Math.floor(course.duration / 5));
                  const credits = course.duration;

                  return (
                    <div key={course.id} className="bg-white rounded-xl shadow hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                      <div className="relative">
                        ...
                        <div className="absolute top-4 right-4 bg-[#F9A826] text-white px-3 py-1 rounded-full text-sm font-medium">
                          Level {course.level === 'beginner' ? '1' : course.level === 'intermediate' ? '3' : '4'}
                        </div>
                      </div>
                      <div className="p-6">
                        ...
                        <div className="grid grid-cols-3 gap-4 text-sm text-gray-700 mb-6">
                          <div className="flex flex-col items-center justify-center p-2 bg-gray-50 rounded-lg">
                            <span className="font-medium text-[#004C3F]">{modules}</span>
                            <span className="text-xs font-medium">Modules</span>
                          </div>
                          <div className="flex flex-col items-center justify-center p-2 bg-gray-50 rounded-lg">
                            <span className="font-medium text-[#004C3F]">{weeks}</span>
                            <span className="text-xs">Weeks</span>
                          </div>
                          <div className="flex flex-col items-center justify-center p-2 bg-gray-50 rounded-lg">
                            <span className="font-medium text-[#004C3F]">{credits}</span>
                        ...
                        <button
                          onClick={() => setSelectedCourse({
                            ...
                            weeks,
                            credits,
                            level: `Level ${course.level === 'beginner' ? '1' : course.level === 'intermediate' ? '3' : '4'}`
                          })}
              ...
              <div className="p-8">
                ...
                <div className="grid grid-cols-3 gap-6 mb-8">
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <div className="text-2xl font-bold text-[#004C3F] mb-1">{selectedCourse.modules}</div>
                    <div className="text-sm text-gray-600">Modules</div>
                  </div>
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <div className="text-2xl font-bold text-[#004C3F] mb-1">{selectedCourse.weeks}</div>
                    <div className="text-sm text-gray-600">Weeks</div>
                  </div>
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <div className="text-2xl font-bold text-[#004C3F] mb-1">{selectedCourse.credits}</div>
                ...
                <div className="space-y-6 mb-8">
                  <div>
                    ...
                    <p className="text-gray-600">
                      This comprehensive course provides you with the knowledge and skills needed to excel in your chosen field.
        ...
        <div className="bg-[#FFF9F3] py-16">
          <div className="max-w-md mx-auto text-center">
            <h2 className="text-2xl font-bold mb-4 text-gray-900">Ready to start learning?</h2>
            <p className="text-gray-600 mb-6">Please log in to access your courses and continue your learning journey.</p>
            <a
              href="/login"
  ...
  // Main course list for authenticated users
  return (
    <div className="pt-16">
      <CourseList />
    </div>
