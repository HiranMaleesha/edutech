      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex justify-between items-center h-16'>
          ...
          <div className='flex items-center space-x-2'>
            <Link
              href='/'
              className='text-2xl font-bold text-[#004C3F] font-poppins flex items-center'
            >
          ...
          <div className='md:hidden flex items-center'>
            {user && (
              <Link
                href='/dashboard'
                className='bg-[#004C3F] text-white px-3 py-2 rounded-lg text-sm font-medium hover:bg-[#003a33] transition-colors mr-2'
              >
                Dashboard
              </Link>
            )}
