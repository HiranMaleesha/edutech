/**
 * Represents a course in the frontend application.
 * Contains all necessary information about a course for display and management.
 */
...
/**
 * Extended user profile data including statistics.
 */
